...
<div align="left">
    ...
    <p align="left">
        <li align="left">GET</li>
        <li align="left">POST</li>
        <li align="left">HEAD</li>
        <li align="left">PUT</li>
        <li align="left">PATCH</li>
        <li align="left">DELETE</li>
        <li align="left">XMLRPC</li>
        <li align="left">CACHE</li>
        <li align="left">BYPASS</li>
        <li align="left">SLOW POST</li>
        <li align="left">SLOW BODY</li>
        <li align="left">SLOWLORIS</li>
        <li align="left">OPTIONS</li>
        <li align="left">RANDOM</li>
        <li align="left">TRACE</li>
        <li align="left">CONNECT</li>
        <li align="left">PROPFIND</li>
        <li align="left">LOCK</li>
        <li align="left">UNLOCK</li>
        <li align="left">COPY</li>
        <li align="left">MOVE</li>
        <li align="left">ARBITRARY STRING</li>
    </p>
    <br>
    <h4 align="center">LAYER 4: TRANSPORT</h4>
    <p align="left">
        <li align="left">TCP</li>
        <li align="left">UDP</li>
        <li align="left">SYN</li>
        <li align="left">ACK</li>
        <li align="left">FIN</li>
        <li align="left">RST</li>
    </p>
    <br>
    <h4 align="center">LAYER 3</h4>
    <p align="left">
        <li align="left">ICMP</li>
    </p>
</div>
...
<div align="left">
    ...
    <p align="left">
        ...
        <li align="left">Multi HTTP Version Support</li>
